...
export const theWhiteHouseAiActionPlan: BlogPost = {
  id: "the-white-house-ai-action-plan",
  title: "The White House AI Action Plan: a new chapter in U.S. AI policy",
...
To learn more about our mission to help build a better Internet, start here. If you're looking for a new career direction, check out our open positions.`,
  author: {
    name: "Zaid Zaid & Vincent Voci",
    role: "Policy Team"
  },
  publishedAt: "2025-07-25",
  readTime: "6 min read",
  tags: ["AI Policy", "Government", "National Security", "Open Source", "Cybersecurity", "Export Controls", "Innovation"],
  featured: false
};